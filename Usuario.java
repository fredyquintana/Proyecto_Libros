...
public class Usuario extends JFrame {
	...
	public Insertar() {
		...
		JLabel lblNewLabel = new JLabel("MENU USUARIO");
		...
		JLabel lblNewLabel_1_1_3 = new JLabel("Dirección");
		...
		textDir.setBounds(134, 159, 127, 20);
		...
		btnSQL.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String Dir = textCon.getText();
				
				u1 = new Usuario(id, nombre, apellido, correo, Dir);
				try {
					daoSQL.create(u1);
